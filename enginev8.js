...
function buildIndex() {
    var indexString = '';
    var i;
    indexString = " <b>Hal:</b> <select name='index' onchange='javascript:void(showpage(this.options[this.selectedIndex].value));'>";
...
document.onkeydown = ocvKeyPressed;
indexSeparator = ' |  ';
